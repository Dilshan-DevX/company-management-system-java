package com.nex.cms.frame.customer;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (invoice != null) {
                ...
                invoice.getjLabel11().setText(String.valueOf(jTable1.getValueAt(row, 1) + " " + (jTable1.getValueAt(row, 2)))); //Customer Name
                invoice.getjLabel36().setText(String.valueOf(jTable1.getValueAt(row, 4))); //Customer Mobile
                invoice.getjFormattedTextField2().setText(String.valueOf(jTable1.getValueAt(row, 6)));
                invoice.getjLabel32().setText(String.valueOf(jTable1.getValueAt(row, 0)));
                invoice.jLabel13().setText(String.valueOf(jTable1.getValueAt(row, 3)));
                this.dispose();
