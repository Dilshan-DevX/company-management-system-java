...
public class selectEmployee extends javax.swing.JFrame {
    ...
    private Loans_Management loans_Management;

    public void setLoans_Management(Loans_Management loans_Management) {
        this.loans_Management = loans_Management;
    }
    ...
    private void RegMail(String EmpId, String UserName, String Password, String lname, String fname, String email) {
        ...
        final String senderPassword = "bqbilezgynkswlgv";  // Use an App Password if using Gmail   bqbi lezg ynks wlgv
...
//                        JOptionPane.showMessageDialog(null, "Email Sending Failed! " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(717, 465));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if (loans_Management != null) {
                loans_Management.getjLabel55().setText(String.valueOf(jTable1.getValueAt(row, 0)));
                loans_Management.getjLabel46().setText(String.valueOf(jTable1.getValueAt(row, 1)));
                this.dispose();
            }
        }
    ...
    private void button4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button4ActionPerformed
        try {
            ...
            if (resultSet.next()) {
                ...
                //                JOptionPane.showMessageDialog(this, "No Rejisterd selectEmployee !", "Warning", JOptionPane.WARNING_MESSAGE);
...
private void reset() {
    ...
    /**
     * @param loans_Management the loans_Management to set
     */
}
